...
* With Team L1:
  ...
  * static page with Jekyllthemes: <br>
    ...
    <img src="https://github.com/19-1-skku-oss/2019-1-OSS-L1/blob/martina/testing_martina/theme_ruby.png" width="400" height="600" style="display:block;margin: 0 auto"/>
