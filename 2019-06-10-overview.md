...
* With Team L1:
  ...
  * static page with Jekyllthemes: [영숙, 민종]--어떻게 만들기 시작하고, 어떻게 hosting을 하는지, '후기 남기는 식'으로 해서 남겨주세요.<br>
    민종(한글 페이지 담당) : 
    번역한 document를 static page로 보여주는 것이 제일 접근하기 좋고 보기 편하다는 생각에 static page에도 큰 관심을 쏟았습니다.
    ...
    우리가 만든 두개의 static page를 모두 보여주기 위해 기존에 적용되어 있던 static page는 fork 하여 다른 repo로 옮겼고, 기존에 잇는 repo에서 작업을 하고 난 후에 옮긴 repo에 pull request하는 방식으로 운용하였습니다.
